...
APP_NAME=global_app
APP_HOME=/gamejelly_gong2/deploy_global
APP_USER=root
...
-server -Xms512m -Xmx1024m -XX:MaxPermSize=128m -XX:NewRatio=3 \
-XX:+UseConcMarkSweepGC -XX:+ExplicitGCInvokesConcurrent \
-verbose:gc -XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:$LOG_DIR/${APP_NAME}_gc.log"
...
$JAVA_OPSTS \
com.gamejelly.gong2.global.app.GlobalApp"
