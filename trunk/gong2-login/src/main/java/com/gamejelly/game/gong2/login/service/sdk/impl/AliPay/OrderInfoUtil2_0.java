...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String app_id, String totalAmount, String outTradeNo,
			String orderName, String accountNameAndServerId, String notifyUrl) {
		Map<String, String> keyValues = new HashMap<String, String>();
		...
		keyValues.put("biz_content",
				"{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\""
						+ totalAmount + "\",\"subject\":\"" + orderName + "\",\"body\":\"" + accountNameAndServerId
		...
		keyValues.put("timestamp", DataUtils.formatDate(System.currentTimeMillis(), "yyyy-MM-dd HH:mm:ss"));
